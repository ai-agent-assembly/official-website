...
import {
  Hero, Problem, ThreePillars, HowItWorks, ChooseYourPath, FinalCTA,
      ...
      <main>
        ...
        <section className={`${styles.section} ${styles.center}`}>
          <div className={styles.inner}>
            ...
            <h2 className={styles.h2}>Build notes, engineering, and security write-ups</h2>
            <p className={styles.lead}>Why the runtime boundary matters and how we&rsquo;re building it.</p>
            <div className={styles.ctaRow} style={{justifyContent: 'center', marginTop: '1.25rem'}}>
              <Link className={styles.btnGhost} to="/blog">Read the blog →</Link>
            </div>
          </div>
        </section>
        <FinalCTA />
