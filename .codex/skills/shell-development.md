<!-- horonom:generated -->
<!-- Source: horonomy/.github agents/skills/shell-development/SKILL.md. Provisional Codex projection shape — see agents/common/README.md. Do not hand-edit — rerun `python3 agents/common/project_skills.py`. -->
...
- As a substitute for a language skill's own build/test commands invoked
  _from_ a shell script — the script glue is this skill's concern, the
