<!-- horonom:generated -->
<!-- Source: horonomy/.github agents/skills/design-qa/SKILL.md. Provisional Codex projection shape — see agents/common/README.md. Do not hand-edit — rerun `python3 agents/common/project_skills.py`. -->

# SKILL.md — design-qa

## Purpose

Verify a product's _rendered_ user experience — not just that it functions.
...
`pyproject.toml`. Whether a product _has a material rendered surface worth
design-scrutiny_ is not that kind of question — any stack (CLI, library,
...
signal that _some_ code renders HTML; it cannot tell "this route is a
...
- To claim functional PASS implies design PASS, or vice versa. **A green
  ...
  passing assertions. Screenshots and visual diffs are _evidence_, gathered
