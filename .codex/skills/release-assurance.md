<!-- horonom:generated -->
<!-- Source: horonomy/.github agents/skills/release-assurance/SKILL.md. Provisional Codex projection shape — see agents/common/README.md. Do not hand-edit — rerun `python3 agents/common/project_skills.py`. -->
...
- A product with its own stricter release gate (e.g. a security-sensitive
  ...
  window) — run this skill's checks _and_ the stricter product gate; never
