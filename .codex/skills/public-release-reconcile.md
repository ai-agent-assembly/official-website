<!-- horonom:generated -->
<!-- Source: horonomy/.github agents/skills/public-release-reconcile/SKILL.md. Provisional Codex projection shape — see agents/common/README.md. Do not hand-edit — rerun `python3 agents/common/project_skills.py`. -->
...
2. Classify the product's overall state using the 7-state contract in
   ...
   BLOCKED_EXTERNAL / FAILED) — pick the state the _evidence_ supports,
