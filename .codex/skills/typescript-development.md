<!-- horonom:generated -->
<!-- Source: horonomy/.github agents/skills/typescript-development/SKILL.md. Provisional Codex projection shape — see agents/common/README.md. Do not hand-edit — rerun `python3 agents/common/project_skills.py`. -->
...
- **Never enable `skipLibCheck`, weaken `strict`, or loosen any other
  ...
  If a check is slow, narrow _what_ you run (see `references/`), not _how
  strict_ it is.
