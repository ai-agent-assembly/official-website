...
yet invoked _through_ `design-qa`'s structured verdict format — that
...
- Reach a specific _state_ deliberately (logged out / logged in / empty
...
beyond what's emulated, or that the _design itself_ is good — dimension
