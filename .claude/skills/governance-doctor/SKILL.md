<!-- horonom:generated -->
<!-- Source: horonomy/.github agents/skills/governance-doctor/SKILL.md. Do not hand-edit — rerun `python3 agents/common/project_skills.py`. -->
...
2. Compare each generated file's provenance header
   ...
   - Recorded version behind current, but content still matches what _that
     older_ version would have produced → WARN (merely stale, not corrupt).
