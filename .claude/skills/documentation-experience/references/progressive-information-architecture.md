...
Each layer is a _kind of content_, not a literal single page or URL depth.
...
For a reader who needs to understand _behavior_, not just copy a command:
...
**Two non-negotiables**: never force a reader to read Layer 3 to _learn_
