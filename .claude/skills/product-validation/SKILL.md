<!-- horonom:generated -->
<!-- Source: horonomy/.github agents/skills/product-validation/SKILL.md. Do not hand-edit — rerun `python3 agents/common/project_skills.py`. -->
...
`engineering-loop`'s Full Gate stage is the _development_-side floor
(tests/lint/build pass); this skill's quality report is the _product_-side
