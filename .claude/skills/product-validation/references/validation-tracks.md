...
_only_ what the docs say, and every gap between "what the docs claim" and
...
docs-content fixes through `documentation-experience`, but the _defect
that the docs claim doesn't hold_ still goes through this skill's
